...
<template>
    ...
    <AuthenticatedLayout>
        <template #banner>
            <div class="border-b border-hairline bg-surface-strong">
                <div class="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                        <span class="text-sm font-medium text-body shrink-0">
                            Link da sessão:
                        </span>
                        ...
                        <input
                            ...
                            :value="shareUrl"
                            readonly
                            class="min-w-0 flex-1 rounded-md border border-hairline bg-surface-card px-3 py-2 text-sm text-ink focus:outline-none focus:ring-2 focus:ring-primary"
