                ...
                <div class="bg-surface-card p-6 shadow sm:rounded-lg">
                    <header class="mb-6">
                        <h3 class="text-lg font-medium text-ink">
                            Integração com a IA (Anthropic)
                        </h3>
                        <p class="mt-1 text-sm text-muted">
                            Configure a chave e o modelo usados para ler os recibos.
                            A chave é armazenada de forma criptografada e nunca é
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <div>
                            ...
                            <TextInput
                                ...
                                autocomplete="off"
                                :placeholder="has_api_key ? api_key_preview : 'sk-ant-...'"
                            />
